...
<body>
    ...
    <div class="newmusica">
        <img src="albums/albumimg.png" alt="">
        <form class="newmusicaform" action="logicas/logicamusica.php" method="POST" enctype="multipart/form-data">

            <div class="divnameinput">
                <label for="imgmsc"> escolha a capa </label>
                <input type="file" id="imgmsc" name="capamsc">
            </div>
            <div class="divnameinput">
                <label for="nomemsc"> nome da sua musica </label>
                <input type="text" id="nomemsc" name="nomemsc">
            </div>
            <div class="divnameinput">
                <label for="linkmsc"> link da sua musica </label>
                <input type="text" id="linkmsc" name="linkmsc">
            </div>
            <input class="button" type="submit" placeholder="enviar sua música">
        </form>
    </div>
